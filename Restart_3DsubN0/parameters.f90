...
if (ifilter.eq.1) print *,'Filter            : on'
if (ifilter.eq.0) print *,'Filter            : off'
...
longueur=index(filenoise,' ')-1 
if (iin==2) open(40,file=filenoise(1:longueur),form='unformatted',status='unknown') 
longueur=index(filesauve,' ')-1 
if (nxboite/=0 .or. iin==3) open(50,file=filesauve(1:longueur),form='unformatted',status='unknown') 
